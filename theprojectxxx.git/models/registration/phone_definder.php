...
'380'=>Array(
        ...
        'cityCodeLength'=>4,
        'zeroHack'=>true,
        'exceptions'=>Array(39,50,63,66,67,68,91,92,93,94,95,96,97,98,99,44,432,1762,562,622,412,522,564,53615,642,322,448,629,512,482,532,3355,1821,403,222,1852,356,3371,267,3443,1694,1965,3058,1627,3385,3356,2718,3370,3260,3231,2785,309,2857,2957,2911,294,1705,3,295,3250,3387,2523,3246,2674,1854,3433,1711,251,2958,2477,2984,307,542,352,572,552,382,472,462,654),
        'exceptions_max'=>5,
        'exceptions_min'=>1
    ),
'378'=>Array(
...
'375'=>Array(
        ...
        'cityCodeLength'=>4,
        'zeroHack'=>false,
        'exceptions'=>Array(17,29,33,44,25,163,162,232,222),
        'exceptions_max'=>3,
        'exceptions_min'=>2
    ),
'374'=>Array(

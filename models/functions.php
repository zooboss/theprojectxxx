    ...
    if(isset($_FILES["file"]["type"])) {
          ...
          )
        {
            ...
            else
            {
                ...
                if ( file_exists( $_SERVER['DOCUMENT_ROOT'] . "/theprojectxxx/img/avatars/user-".$UserID.".".$imgExt ) ) {
                    unlink( $_SERVER['DOCUMENT_ROOT'] . "/theprojectxxx/img/avatars/user-".$UserID.".".$imgExt );

                    $sourcePath = $_FILES['file']['tmp_name']; //Храним временный путь к фаулу. 
                    $targetPath = $_SERVER['DOCUMENT_ROOT'] . "/theprojectxxx/img/avatars/user-".$UserID.".".$imgExt; // Директория хранения

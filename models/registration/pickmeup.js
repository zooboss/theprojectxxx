	...
	function fill (target) {
		...
		for (var i = 0; i < options.calendars; i++) {
			...
			if (dom_has_class(root_element, 'pmu-view-years')) {
				...
				header = (local_date.getFullYear() - 30) + ' - ' + (local_date.getFullYear() + 33);   /* Года после и перед текущим в меню выбора*/
			...
			(function () {
				var years_elements  = [],
					start_from_year = local_date.getFullYear() - 30,
